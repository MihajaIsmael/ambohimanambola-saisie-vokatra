...
To ensure members exist in the database before using the application, place your CSV file in the `init-db/` folder with the following structure:

**File path:** `init-db/mpivavaka.csv`  
**Format:** `"ID","Full Name","Location/Address"`

Example (`init-db/mpivavaka.csv`):
```csv
