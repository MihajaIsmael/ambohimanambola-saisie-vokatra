...
<body>
    ...
    <div class="main-layout">
        ...
        <div class="container">
            ...
            <form action="controllers/PrintController.php" method="POST" target="print_popup" onsubmit="openPrintPopup();">
        ...
        <div class="sidebars-column">
            ...
            <div class="sidebar mpivavaka-sidebar">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; border-bottom: 2px solid #f4f4f9; padding-bottom: 10px;">
                    ...
                    <a href="history.php" style="font-size: 13px; color: #3498db; text-decoration: none; font-weight: bold;"></a>
                </div>
